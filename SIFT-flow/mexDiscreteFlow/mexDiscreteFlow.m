...
%       nHierarchy:   (2)  the number of hierarchies in the efficient belief propagation (BP) implementation
...
%
% Arugments "winSizeX" and "winSizeY" should have also the same dimension as im1. These two 
...
% and flow(:,:,2) is the vertical component. The height and width of flow is the same as im1.
%
